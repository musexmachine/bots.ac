...
### [High] EvoTest: Evolutionary Test‑Time Learning for Self‑Improving Agentic Systems ([paper](self-learning-agents/evotest/PAPER.md))
...
### [High] Self‑Evolving Agents with Reflective and Memory‑Augmented Abilities (SAGE) ([paper](self-learning-agents/sage/PAPER.md))
...
### [High] Mem0: Building Production‑Ready AI Agents with Scalable Long‑Term Memory ([paper](self-learning-agents/mem0/PAPER.md))
...
### [High] EvoAgentX: An Automated Framework for Evolving Agentic Workflows ([paper](self-learning-agents/evoagentx/PAPER.md))
...
### [Medium] MemInsight: Autonomous Memory Augmentation for LLM Agents ([paper](self-learning-agents/meminsight/PAPER.md))
...
### [Medium] Memory OS of AI Agent ([paper](self-learning-agents/memory_os/PAPER.md))
...
### [Medium] AFLOW: Automating Agentic Workflow Generation ([paper](self-learning-agents/aflow/PAPER.md))
...
### [Medium] Self‑Reasoning Language Models ([paper](self-learning-agents/self_reasoning_language_models/PAPER.md))
...
### [Medium] Self‑Challenging Language Model Agents ([paper](self-learning-agents/self_challenging_language_model_agents/PAPER.md))
...
### [Medium] SELF‑REFINE: Iterative Refinement with Self‑Feedback ([paper](self-learning-agents/self_refine/PAPER.md))
...
### [Medium] Reflexion: Language Agents with Verbal Reinforcement Learning ([paper](self-learning-agents/reflexion/PAPER.md))
...
### [Medium] SELF: Self‑Evolution with Language Feedback ([paper](self-learning-agents/self/PAPER.md))
...
### [Medium] Enabling Self‑Improving Agents to Learn at Test Time with Human‑in‑the‑Loop Guidance (ARIA) ([paper](self-learning-agents/aria/PAPER.md))
...
### [Low] AgentGen: Enhancing Planning Abilities for Large Language Model based Agents via Environment and Task Generation ([paper](self-learning-agents/agentgen/PAPER.md))
...
### [Low] Learn‑by‑interact: A Data‑Centric Framework for Self‑Adaptive Agents in Realistic Environments ([paper](self-learning-agents/learn_by_interact/PAPER.md))
...
### [Low] Self Rewarding Self Improving (RLSR) ([paper](self-learning-agents/self_rewarding_self_improving/PAPER.md))
...
### [Low] Self‑Evolving Curriculum for LLM Reasoning (SEC) ([paper](self-learning-agents/self_evolving_curriculum/PAPER.md))
...
### [Low] Vision‑Zero: Scalable VLM Self‑Evolution via Multi‑Agent Self‑Play ([paper](self-learning-agents/vision_zero/PAPER.md))
